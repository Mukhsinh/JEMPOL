...
// Mobile-First Tiket Internal Form - Tampilan Clean & Modern
const MobileTiketInternalForm: React.FC = () => {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-violet-400 via-purple-500 to-indigo-600 flex items-center justify-center p-6">
        ...
        <div className="relative bg-white rounded-[2rem] shadow-2xl p-8 max-w-sm w-full text-center">
          <div className="w-24 h-24 bg-gradient-to-br from-violet-400 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg shadow-purple-500/30">
          ...
          <div className="bg-gradient-to-r from-violet-400 to-purple-500 rounded-2xl p-6 mb-6 text-white shadow-lg">
          ...
          <button 
            onClick={resetForm} 
            className="w-full py-4 bg-gradient-to-r from-violet-400 to-purple-500 text-white rounded-2xl font-bold text-lg shadow-lg shadow-purple-500/30 active:scale-95 transition-transform"
          >
            Buat Tiket Baru
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-400 via-purple-500 to-indigo-600 flex flex-col">
      {/* Decorative */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-20 -right-20 w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
      ...
      <header className="relative z-10 px-6 pt-8 pb-4">
        ...
        <h1 className="text-white text-2xl font-bold mb-1">Tiket Internal</h1>
        <p className="text-white/80 text-sm">Khusus untuk petugas internal</p>
              ...
              {currentStep === 3 && (
                <div className="space-y-6 animate-slideUp">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center relative hover:border-purple-400 transition-colors">
                    ...
                    />
                    <div className="w-16 h-16 bg-gradient-to-br from-violet-400 to-purple-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-purple-500/30">
            ...
            <div className="max-w-md mx-auto flex gap-3">
              ...
              {currentStep < totalSteps ? (
                <button 
                  ...
                  className="flex-1 py-4 bg-gradient-to-r from-violet-400 to-purple-500 text-white rounded-xl font-bold text-lg shadow-lg shadow-purple-500/30 disabled:opacity-50 disabled:shadow-none flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
                >
                  Lanjutkan
                ...
                <button 
                  type="submit" 
                  disabled={submitting}
                  className="flex-1 py-4 bg-gradient-to-r from-violet-400 to-purple-500 text-white rounded-xl font-bold text-lg shadow-lg shadow-purple-500/30 disabled:opacity-50 flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
                >
                  {submitting ? (
                    <>
...
export default MobileTiketInternalForm;
