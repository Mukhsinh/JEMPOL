  ...
  const fetchAppSettings = async () => {
    try {
      ...
      if (data.success && data.data) {
        setAppSettings({
          app_name: data.data.app_name || 'Sistem Pelacakan Tiket',
          institution_name: data.data.institution_name || 'Instansi',
          logo_url: data.data.logo_url || '',
          app_footer: data.data.app_footer || '',
          call_center_number: data.data.call_center_number || '112',
          whatsapp_help_number: data.data.whatsapp_help_number || '',
          contact_phone: data.data.contact_phone || '',
          contact_email: data.data.contact_email || '',
          institution_address: data.data.institution_address || '',
