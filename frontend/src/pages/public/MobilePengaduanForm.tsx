...
// Mobile-First Pengaduan Form - Tampilan Clean & Modern
const MobilePengaduanForm: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-400 via-green-500 to-teal-600 flex items-center justify-center p-6">
        ...
        <div className="relative bg-white rounded-[2rem] shadow-2xl p-8 max-w-sm w-full text-center">
          ...
          <div className="bg-gradient-to-r from-orange-400 to-rose-500 rounded-2xl p-6 mb-6 text-white shadow-lg">
          ...
          <button 
            onClick={resetForm} 
            className="w-full py-4 bg-gradient-to-r from-orange-400 to-rose-500 text-white rounded-2xl font-bold text-lg shadow-lg shadow-orange-500/30 active:scale-95 transition-transform"
          >
            Buat Laporan Baru
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-400 via-rose-500 to-pink-600 flex flex-col">
      {/* Decorative */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-20 -right-20 w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
      ...
      <header className="relative z-10 px-6 pt-8 pb-4">
        ...
        <h1 className="text-white text-2xl font-bold mb-1">Buat Pengaduan</h1>
        <p className="text-white/80 text-sm">Sampaikan keluhan atau saran Anda</p>
              ...
              {currentStep === 3 && (
                <div className="space-y-6 animate-slideUp">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center relative hover:border-orange-400 transition-colors">
                    ...
                    />
                    <div className="w-16 h-16 bg-gradient-to-br from-orange-400 to-rose-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-orange-500/30">
            ...
            <div className="max-w-md mx-auto flex gap-3">
              ...
              {currentStep < totalSteps ? (
                <button 
                  ...
                  className="flex-1 py-4 bg-gradient-to-r from-orange-400 to-rose-500 text-white rounded-xl font-bold text-lg shadow-lg shadow-orange-500/30 disabled:opacity-50 disabled:shadow-none flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
                >
                  Lanjutkan
                ...
                <button 
                  type="submit" 
                  disabled={submitting}
                  className="flex-1 py-4 bg-gradient-to-r from-orange-400 to-rose-500 text-white rounded-xl font-bold text-lg shadow-lg shadow-orange-500/30 disabled:opacity-50 flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
                >
                  {submitting ? (
                    <>
...
export default MobilePengaduanForm;
