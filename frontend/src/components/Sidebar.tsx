                    ...
                    <div className="mb-2">
                        ...
                        {isSettingsOpen && (
                            <div className="mt-2 ml-6 flex flex-col gap-1">
                                ...
                                <Link
                                    to="/settings/qr-link"
                                    className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${isActive('/settings/qr-link')
                                        ? 'bg-primary text-white shadow-md shadow-blue-500/20'
                                        : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800'
                                        }`}
                                >
                                    <span className="material-symbols-outlined text-orange-500">qr_code_2</span>
                                    <p className="text-sm font-medium">Pengaturan QR Link</p>
                                </Link>
